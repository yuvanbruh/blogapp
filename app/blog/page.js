...
const contents = [
  {
    ...
    desc: "Website visitors today demand a frictionless user expericence — especially when writing. Because of the hight standards we tend to offer.",
  },
  {
    img: "https://www.material-tailwind.com/image/blog-10.jpeg",
    title: "Last visits in US-Enhanced blog",
  ...
  return (
    <section className="container mx-auto px-8 py-10 lg:py-28">
      ...
      >
        ...
        to appreciate every moment. So write it up.
      </Typography>
